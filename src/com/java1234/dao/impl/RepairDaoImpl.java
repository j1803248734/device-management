...
public class RepairDaoImpl implements RepairDao{
	...
	public List<Repair> find(PageBean pageBean, Repair s_repair) {
		StringBuffer sb=new StringBuffer("select * from t_repair t1,t_equipment t2 where t1.equipmentId=t2.id and t1.finishState=2");
		if(s_repair!=null){
	...
	public List<Repair> finding(PageBean pageBean, Repair s_repair){
		StringBuffer sb=new StringBuffer("select * from t_repair t1,t_equipment t2 where t1.equipmentId=t2.id and t1.finishState=1");
		if(s_repair!=null){
			if(StringUtil.isNotEmpty(s_repair.getEquipmentName())){
				sb.append(" and t2.name like '%"+s_repair.getEquipmentName()+"%'");
			}
